		...
		<div id="page">
			<div class="header Fixed">
				<div class="row">
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" id="header_news"><h4>News</h4></div>
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" id="header_gb"><h1>GB RADIO</h1></div>
				</div>
			</div>
										
			<section class="container listview">
			
				<c:forEach var="post" items="${listePosts}">
				<a href="article?id=${post.id}">
					<div class="section" id="${post.id}">
						<div class="col-xs-3">
							<img class="img_news" src="${post.type.picture}" alt="logo_theme">
						</div>
						
						<div class="col-xs-7 rubrique_menu">
							<h5>${post.title}</h5>
							<h6>${post.type.theme}</h6>
						</div>
