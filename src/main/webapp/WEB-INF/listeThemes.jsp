		...
		<div id="page">
			<div class="header Fixed">
				<div class="row">
					...
					<div class="col-xs-2" id="header_theme"><h4>${themePost.type.theme}</h4></div>
					<div class="col-xs-8" id="header_gb"><h1>GB RADIO</h1></div>
				</div>
			</div>
			...
			<section class="container listview">
				...
				<c:forEach var="listeThemes" items="${listeThemes}">
				<a href="article?id=${listeThemes.id}">
					<div class="section" id="${listeThemes.id}">
						<div class="col-xs-3">
							<img class="img_news" src="${listeThemes.type.picture}" alt="logo_theme">
						</div>
						
						<div class="col-xs-7 rubrique_menu">
							<h5>${listeThemes.title}</h5>
							<h6>${listeThemes.type.theme}</h6>
						</div>
						
						<div class="col-xs-2">
							<img class="fleche_news" src="img/fleche.png"/>
						</div>
					</div>					
				</a>
				</c:forEach>
